          ...
          <div className="col mb-7" >
            <div className="card">
              ...
              <div className="card-body">
                ...
                <button onClick={(e) => wordCloud(e, "1")}  className= {"button"} style={{backgroundColor: "rgb(42, 82, 190)" , color : "#ffffff" , border : "rgb(42, 82, 190)"}}>See Famous Dishes</button>
          ...
          <div className="col mb-7" >
            <div className="card">
              ...
              <div className="card-body">
                ...
                <button onClick={(e) => wordCloud(e, "2")}  className= {"button"} style={{backgroundColor: "rgb(42, 82, 190)" , color : "#ffffff" , border : "rgb(42, 82, 190)"}}>See Famous Dishes</button>
              </div>
            </div>
          </div>
          <div className="col mb-6" onClick={(e) => restuarantItems(e, "3")}>
            <div className="card">
              ...
              <div className="card-body">
                ...
                <button onClick={(e) => wordCloud(e, "3")}  className= {"button"} style={{backgroundColor: "rgb(42, 82, 190)" , color : "#ffffff" , border : "rgb(42, 82, 190)"}}>See Famous Dishes</button>
